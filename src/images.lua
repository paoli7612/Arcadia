function Spritesheet(grill, type)
  ...
  elseif type == "basictiles" then
    ...
    spritesheet.quads["wall"]["lava"] = {get_image(2,8),get_image(2,9),get_image(3,9)}
    ...
    spritesheet.quads["floor"]["clay"] = {get_image(3,7),get_image(5,7),get_image(4,7)}
    spritesheet.quads["floor"]["stairs"] = {get_image(2,12),get_image(2,13),get_image(0,14),get_image(1,14)}
    ...
    spritesheet.quads["decor"]["bed_red"] = get_image(3,6)
    spritesheet.quads["decor"]["bed_green"] = get_image(3,5)
    spritesheet.quads["decor"]["bed_blue"] = get_image(5,6)
